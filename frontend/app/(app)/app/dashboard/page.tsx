...
export default function DashboardPage() {
  ...
  const { data: coursesData, isLoading: coursesLoading } = useQuery({
    ...
    queryFn: () => courseService.list({ limit: 4 }),
  });

  const { data: assignmentsData, isLoading: assignmentsLoading } = useQuery({
    queryKey: ["assignments", "upcoming"],
    queryFn: () => assignmentService.list({ limit: 5 }),
  });
          ...
          <CardContent className="p-3 pt-0 sm:p-6 sm:pt-0">
            <div className="text-xl sm:text-2xl font-bold">
              {notificationsLoading ? (
                ...
                notificationsData?.notifications.filter((n) => !n.is_read)
                  .length || 0
              )}
            </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between p-4 sm:p-6">
              <div>
                ...
                <CardDescription className="text-xs sm:text-sm">Your enrolled courses</CardDescription>
              </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between p-4 sm:p-6">
              <div>
                ...
                <CardDescription className="text-xs sm:text-sm">Assignments due soon</CardDescription>
              </div>
              <Button variant="ghost" size="sm" asChild className="touch-manipulation">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="font-medium text-sm sm:text-base line-clamp-1">{notification.title}</p>
