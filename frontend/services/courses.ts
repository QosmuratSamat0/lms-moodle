...
export const courseService = {
  list: async (
    ...
    // Backend returns an array directly, not wrapped in CourseListResponse
    return api.get<Course[]>("/courses", params as QueryParams);
  },
  ...
  getMyEnrollments: async (studentId: string): Promise<Enrollment[]> => {
