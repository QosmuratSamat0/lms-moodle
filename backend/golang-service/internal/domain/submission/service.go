...
type Service interface {
	...
	ListByAssignment(ctx context.Context, assignmentID uuid.UUID, page, limit int) (*SubmissionListResponse, error)
...
func (s *service) ListByAssignment(ctx context.Context, assignmentID uuid.UUID, page, limit int) (*SubmissionListResponse, error) {
	offset := (page - 1) * limit
	submissions, total, err := s.repo.ListByAssignment(ctx, assignmentID, limit, offset)
	if err != nil {
