...
type Repository interface {
	...
	ListByAssignment(ctx context.Context, assignmentID uuid.UUID, limit, offset int) ([]SubmissionWithDetails, int64, error)
...
func (r *repository) ListByAssignment(ctx context.Context, assignmentID uuid.UUID, limit, offset int) ([]SubmissionWithDetails, int64, error) {
